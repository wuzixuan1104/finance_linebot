    ...
    <div id='menu'>
      ...
      <div id='menu-main'>
        <div>
          ...
          <div>
            <a href="<?php echo $url = '';?>" class='icon-16<?php echo isset ($current_url) && $url === $current_url ? ' active' : '';?>'>前台會員</a>
      <?php if (Admin::current()->in_roles (array (AdminRole::ROLE_ADMIN))) { ?>
              <a href="<?php echo $url = '';?>" class='icon-15<?php echo isset ($current_url) && $url === $current_url ? ' active' : '';?>'>後台會員</a>
      <?php } ?>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <a href="<?php echo $url = '';?>" class='icon-42<?php echo isset ($current_url) && $url === $current_url ? ' active' : '';?>'>廣告分類</a>
            <a href="<?php echo $url = '';?>" class='icon-19<?php echo isset ($current_url) && $url === $current_url ? ' active' : '';?>'>廣告列表</a>
          </div>
        </div>

        <div>
          <span class='icon-14'>興趣</span>
          <div>
            <a href="<?php echo $url = '';?>" class='icon-42<?php echo isset ($current_url) && $url === $current_url ? ' active' : '';?>'>興趣分類</a>
          </div>
        </div>
