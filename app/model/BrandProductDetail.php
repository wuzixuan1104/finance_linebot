...
class BrandProductDetail extends Model {
  static $table_name = 'brand_product_details';
  ...
  public function __construct ($attrs = array (), $guardAttrs = true, $instantiatingViafind = false, $newRecord = true) {
    ...
    // 設定圖片上傳器
    Uploader::bind ('pic', 'BrandProductDetailPicImageUploader');

    // 設定檔案上傳器
    Uploader::bind ('file', 'BrandProductDetailFileFileUploader');
  }
...
/* -- 圖片上傳器物件 ------------------------------------------------------------------ */
class BrandProductDetailPicImageUploader extends ImageUploader {
...
/* -- 檔案上傳器物件 ------------------------------------------------------------------ */
class BrandProductDetailFileFileUploader extends FileUploader {
}
