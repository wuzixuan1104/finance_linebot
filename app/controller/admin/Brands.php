...
class Brands extends AdminRestfulController {
  ...
  public function index() {
    ...
    $search = Restful\Search::create ($where)
                            ...
                            ->input ('品牌名稱', function ($val) { return Where::create ('name LIKE ?', '%' . $val . '%'); }, 'text')
                            ->input ('統一編號', function ($val) { return Where::create ('tax_number LIKE ?', '%' . $val . '%'); }, 'text')
  ...
  public function show($obj) {
    return $this->view->setPath('admin/Brands/show.php');
  }
